...
const SCALES:any = {
  ...
  PRWE: require('../scales/prwe.json'),
  PRTEE: require('../scales/prtee.json'),
...
export default function ScaleScreen({ route, navigation }:any){
  ...
  useEffect(()=>{ loadForm(id).then(s=>{
    ...
    const map:any = { 'Coluna lombar':'ODI', 'Joelho':'KOOS', 'Quadril':'HOOS', 'Ombro':'DASH', 'Cotovelo':'PRTEE', 'Punho/Mão':'PRWE' };
